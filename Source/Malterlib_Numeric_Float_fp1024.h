...
using CIEEEFloat1024 = NMib::NNumeric::TCFloat<1, 63, 1024-64, 0>;
using CIEEEFloat1024Emu = NMib::NNumeric::TCFloat<1, 63, 1024-64, 0, NMib::NNumeric::CNoImplicit, 0>;
...
namespace NMib::NNumeric
{
	...
	extern template class TCFloat<1, 63, 1024-64, 0>;
	extern template class TCFloat<1, 63, 1024-64, 0, CNoImplicit, 0>;
#endif
}
